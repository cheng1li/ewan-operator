...
import (
	...
	icnv1alpha1 "github.com/cheng1li/sdewan-operator/pkg/apis/icn/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &icnv1alpha1.Sdewan{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *icnv1alpha1.Sdewan) *corev1.Pod {
